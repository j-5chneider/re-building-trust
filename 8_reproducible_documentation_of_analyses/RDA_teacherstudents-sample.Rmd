...
subtitle: "Teacher student sample"
header-includes:
   - \usepackage{sansmath}
   - \sansmath
output: 
...
# Data import
The data is included within this reproducible report and can be downloaded `r xfun::embed_file("rbt_students_w.csv", text ="here")`.
...
data_rbt <- read_csv(here("8_reproducible_documentation_of_analyses", "rbt_students_w.csv"))
```
