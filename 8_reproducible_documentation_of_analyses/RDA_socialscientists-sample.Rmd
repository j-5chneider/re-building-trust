...
# data_rbt <- read_csv(here("8_reproducible_documentation_of_analyses", "rbt_sci_w.csv"))
rbt <- read_csv(here("8_reproducible_documentation_of_analyses/rbt_sci.csv"))
rbt_sci_1 <- read_csv(here("8_reproducible_documentation_of_analyses/rbt_sci_1.csv"))
```

The data is included within this reproducible report and can be downloaded `r xfun::embed_file(here("8_reproducible_documentation_of_analyses/rbt_sci.csv"), text ="here (object rbt)")` and `r xfun::embed_file(here("8_reproducible_documentation_of_analyses/rbt_sci_1.csv"), text ="here (object rbt_sci_1)")`.
...
res_tch_data <- data_tch%>%
  ...
  summarize(freq = n())%>%
  ungroup()%>%
  mutate(treat = case_when(treat == "GB" ~ "Grayed out badges",
...
ggsave("8_reproducible_documentation_of_analyses/Fig/Fig5.jpg", res_tch_plot_pub, width = 130, height = 50, units = "mm", dpi = 300, scale = 2.4)
